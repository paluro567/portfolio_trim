...
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | ---: | --- |
| **TSLA** | 5.67% | TRIM | TRIM | TRIM | TRIM | TRIM | NEGATIVE | LOW | 9 | CURRENT |
| **CAKE** | 5.23% | ADD | ADD | ADD | ADD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **CRM** | 5.09% | ADD | ADD | TRIM | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **PLTR** | 4.85% | ADD | ADD | ADD | TRIM | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **ELF** | 4.16% | ADD | ADD | ADD | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **ZETA** | 3.83% | ADD | ADD | ADD | ADD | ADD | POSITIVE | LOW | 9 | CURRENT |
| **IWM** | 3.81% | HOLD | HOLD | ADD | ADD | ADD | NEUTRAL | LOW | 6 | CURRENT |
| **UNH** | 3.72% | TRIM | TRIM | ADD | ADD | ADD | NEGATIVE | LOW | 9 | CURRENT |
| **SOFI** | 3.72% | HOLD | HOLD | HOLD | TRIM | TRIM | NEUTRAL | LOW | 9 | CURRENT |
| **VTI** | 3.33% | HOLD | ADD | ADD | ADD | ADD | POSITIVE | LOW | 6 | CURRENT |
| **PATH** | 3.14% | ADD | ADD | ADD | ADD | ADD | POSITIVE | LOW | 9 | CURRENT |
| **NOW** | 2.79% | ADD | ADD | ADD | TRIM | TRIM | POSITIVE | LOW | 9 | CURRENT |
| **VOO** | 2.41% | HOLD | ADD | ADD | ADD | ADD | POSITIVE | LOW | 6 | CURRENT |
| **META** | 2.33% | TRIM | TRIM | TRIM | TRIM | HOLD | NEGATIVE | LOW | 9 | CURRENT |
| **NKE** | 2.21% | TRIM | HOLD | HOLD | HOLD | HOLD | CONFLICTED | LOW | 9 | CURRENT |
| **CELH** | 1.64% | HOLD | HOLD | TRIM | TRIM | HOLD | NEUTRAL | LOW | 9 | CURRENT |
| **PYPL** | 1.64% | ADD | ADD | ADD | ADD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **SNOW** | 1.63% | ADD | ADD | ADD | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **AMD** | 1.62% | TRIM | TRIM | ADD | HOLD | HOLD | NEGATIVE | LOW | 9 | CURRENT |
| **GOOG** | 1.50% | TRIM | HOLD | HOLD | HOLD | HOLD | CONFLICTED | LOW | 9 | CURRENT |
| **MARA** | 1.38% | TRIM | TRIM | TRIM | HOLD | TRIM | NEGATIVE | LOW | 9 | CURRENT |
| **MSFT** | 1.23% | ADD | ADD | ADD | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **AAPL** | 1.19% | TRIM | HOLD | HOLD | HOLD | ADD | CONFLICTED | LOW | 9 | CURRENT |
| **WYNN** | 1.02% | ADD | HOLD | TRIM | TRIM | TRIM | CONFLICTED | LOW | 9 | CURRENT |
| **PINS** | 0.92% | HOLD | HOLD | HOLD | HOLD | TRIM | CONFLICTED | LOW | 9 | CURRENT |
| **RZLV** | 0.87% | ADD | ADD | HOLD | HOLD | TRIM | POSITIVE | LOW | 8 | CURRENT |
| **COIN** | 0.87% | HOLD | TRIM | TRIM | TRIM | TRIM | NEGATIVE | LOW | 9 | CURRENT |
| **EL** | 0.85% | ADD | ADD | TRIM | TRIM | TRIM | POSITIVE | LOW | 9 | CURRENT |
| **HOOD** | 0.69% | TRIM | TRIM | HOLD | TRIM | TRIM | NEGATIVE | LOW | 9 | CURRENT |
| **AXP** | 0.66% | TRIM | TRIM | TRIM | TRIM | TRIM | NEGATIVE | LOW | 9 | CURRENT |
| **MNDY** | 0.64% | ADD | ADD | ADD | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **PANW** | 0.56% | ADD | ADD | ADD | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **HIMS** | 0.55% | TRIM | TRIM | HOLD | TRIM | TRIM | NEGATIVE | LOW | 9 | CURRENT |
| **GEV** | 0.49% | TRIM | TRIM | TRIM | TRIM | HOLD | NEGATIVE | LOW | 8 | CURRENT |
| **URNM** | 0.48% | ADD | TRIM | TRIM | TRIM | TRIM | NEGATIVE | LOW | 7 | CURRENT |
| **T** | 0.48% | ADD | ADD | TRIM | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **RBRK** | 0.47% | ADD | ADD | ADD | HOLD | HOLD | POSITIVE | LOW | 8 | CURRENT |
| **SPCX** | 0.45% | HOLD | HOLD | HOLD | TRIM | TRIM | NEUTRAL | LOW | 5 | CURRENT |
| **CRWD** | 0.43% | ADD | ADD | ADD | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **BE** | 0.31% | TRIM | TRIM | TRIM | HOLD | HOLD | NEGATIVE | LOW | 9 | CURRENT |
| **ORCL** | 0.28% | HOLD | TRIM | TRIM | HOLD | HOLD | NEGATIVE | LOW | 9 | CURRENT |
| **MA** | 0.27% | ADD | ADD | ADD | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **SMCI** | 0.23% | HOLD | HOLD | TRIM | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **TTD** | 0.20% | TRIM | TRIM | TRIM | HOLD | HOLD | NEGATIVE | LOW | 9 | CURRENT |
| **CVX** | 0.19% | ADD | ADD | HOLD | HOLD | ADD | POSITIVE | LOW | 9 | CURRENT |
| **CORZ** | 0.12% | TRIM | TRIM | TRIM | TRIM | TRIM | NEGATIVE | LOW | 8 | CURRENT |
...
| Ticker | Weight | 1W | 1M | 3M | 6M | 1Y | View (1M) | Strength | Groups | Fresh |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | ---: | --- |
| **AMZN** | 10.87% | HOLD | HOLD | HOLD | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **HNST** | 6.34% | HOLD | HOLD | HOLD | HOLD | HOLD | POSITIVE | LOW | 9 | CURRENT |
| **NVDA** | 2.12% | HOLD | HOLD | HOLD | HOLD | HOLD | CONFLICTED | LOW | 9 | CURRENT |
...
| Ticker | Weight | 1W | 1M | 3M | 6M | 1Y | View (1M) | Strength | Groups | Fresh |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | ---: | --- |
| **INFQ** | 0.35% | HOLD | HOLD | HOLD | HOLD | HOLD | NEUTRAL | LOW | 7 | CURRENT |
